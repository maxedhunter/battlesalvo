...
/**
 * OpponentBoard class that implements Board and represents the opponent's board
 */
public class OpponentBoard implements Board {
  ...
  /**
   * Constructor for OpponentBoard class, initializes the height, width, and grid
   *
